...
const buttonStyles = cva(
  'flex gap-1 rounded-md text-sm font-semibold disabled:cursor-default cursor-pointer disabled:pointer-events-none select-none ease-in-out transition-all transition duration-200 border-solid border disabled:opacity-50',
  {
    variants: {
      variant: {
        dark: [
